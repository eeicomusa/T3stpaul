      ...
      <section className="w-full min-h-screen">
        ...
        <div className="max-w-7xl m-auto px-4 sm:px-6 lg:px-8  p-16 pb-8 sm:pb-12 flex flex-col space-y-6 mt-10 sm:mt-16 lg:mt-24">
          ...
          <div>
            ...
            <li>
            <p><strong>Website</strong> refers to Paulo Safaris, accessible from <a href="paulosafaris.co.ke" rel="external nofollow noopener" target="_blank">paulosafaris.co.ke</a></p>
            </li>
            <li>
